...
const watch = (0, _gulp.parallel)((0, _watchForFileChanges2.default)((path, root, stat) => {
  if (!pulling && _AtviseFile2.default.normalizeMtime(stat.mtime) > lastPull) {
    ...
    new _PushStream2.default(source).on('end', () => {
      pushing = false;
      lastPush = _AtviseFile2.default.normalizeMtime(new Date());
    });
  }
}), (0, _watchForServerChanges2.default)(readResult => {
  if (!pushing && _AtviseFile2.default.normalizeMtime(readResult.mtime) > lastPush) {
    pulling = true;
