 ...
 */
class DiffItemStream extends _QueueStream2.default {
  ...
  processChunk(file, handleErrors) {
    handleErrors(null, _nodeOpcua.StatusCodes.Good, done => {
      ...
      if (typeof itemsCache[path] !== 'undefined') {
        ...
        itemsCache[path] = new _DiffItem2.default(file);
      }
...
exports.default = DiffItemStream;
//# sourceMappingURL=DiffItemStream.js.map