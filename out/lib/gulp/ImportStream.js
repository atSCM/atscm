...
var _CallMethodStream = require('../server/scripts/CallMethodStream');
 ...
 */
class ImportStream extends _CallMethodStream2.default {
   ...
   */
  get methodId() {
    return new _NodeId2.default('ns=1;s=AGENT.OPCUA.METHODS.importNodes');
  }
  ...
  handleOutputArguments(file, outputArguments, callback) {
    ...
    if (importStatus.value) {
      _gulplog2.default.debug(`Successfully imported file: ${file.relative}`);
