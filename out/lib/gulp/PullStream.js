...
class PullStream {
  ...
  constructor(readStream) {
    ...
    return _Transformer2.default.applyTransformers(readStream.pipe(mappingStream), _ProjectConfig2.default.useTransformers, _Transformer.TransformDirection.FromDB).pipe((0, _gulp.dest)('./src')).on('finish', () => {
      if (_gulplog2.default.listenerCount('info') > 0) {
