...
class PushStream {
  ...
  constructor(srcStream) {
    ...
    const writeStream = new _WriteStream2.default();
    ...
    return _Transformer2.default.applyTransformers(srcStream.pipe(mappingStream), _ProjectConfig2.default.useTransformers, _Transformer.TransformDirection.FromFilesystem).pipe(writeStream).on('finish', () => {
      if (_gulplog2.default.listenerCount('info') > 0) {
        _readline2.default.cursorTo(process.stdout, 0);
