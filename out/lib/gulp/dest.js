...
class WriteStream extends _stream.Writable {
 ...
 - Resolve all conflicts inside '${renameConfigPath}' and run 'atscm pull' again`); // FIXME: Insert link to node id conflict manual here once 1.0.0 is released.
    ...
    return (0, _fsExtra.outputFile)(renameConfigPath, JSON.stringify(renameConfig, null, '  '));
  }
