...
class Atviseproject {
  ...
  static get useTransformers() {
    return [new _DisplayTransformer.default(), new _ScriptTransformer.ServerscriptTransformer(), new _ScriptTransformer.QuickDynamicTransformer(), new _Mapping.default()];
  }
  /**
