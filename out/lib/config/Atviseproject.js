...
class Atviseproject {
  ...
  static get ServerRelatedNodes() {
    ...
    new _NodeId2.default('AGENT\.HISTORY\..*\.(Stepped|PercentData(Good|Bad)|TreatUncertainAsBad|UseSlopedExtrapolation)'), new _NodeId2.default('AGENT\.OPCUA\.server_url'), new _NodeId2.default('AGENT\.WEBACCESS\.https?[0-9]+\.(state|port)'), new _NodeId2.default('SYSTEM\.INFORMATION\.LOGS\.'), new _NodeId2.default('AGENT.GENERATOR.METHODS'), new _NodeId2.default('AGENT.MIRROR.METHODS'), new _NodeId2.default('AGENT.HISTORY.METHODS'), new _NodeId2.default('AGENT.SCRIPT.METHODS'), new _NodeId2.default('AGENT.OPCUA.METHODS')];
  }
