...
var _ScriptTransformer = _interopRequireDefault(require("../../transform/ScriptTransformer"));
...
class Atviseproject {
  ...
  static get useTransformers() {
    return [new _DisplayTransformer.default(), new _ScriptTransformer.default(), new _Mapping.default()];
  }
  /**
  ...
  static get ServerRelatedNodes() {
    return [new _NodeId.default('AGENT\.OPCUA\.server_url'), new _NodeId.default('AGENT\.WEBACCESS\.https?[^\.]+\.(state)'), new _NodeId.default('SYSTEM\.INFORMATION\.LOGS\.'), new _NodeId.default('AGENT\.GENERATOR\.METHODS'), new _NodeId.default('AGENT\.MIRROR\.METHODS'), new _NodeId.default('AGENT\.HISTORY\.METHODS'), new _NodeId.default('AGENT\.SCRIPT\.METHODS'), new _NodeId.default('AGENT\.OPCUA\.METHODS')];
  }
  /**
