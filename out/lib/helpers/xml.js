...
function textContent(node) {
  ...
  const contentNode = node.elements[0]; // FIXME: Only works for { type: 'text', text: 'value' } and { type: 'cdata', cdata: 'data' }
