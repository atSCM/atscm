 ...
 */
const Type = _nodeid.NodeId.NodeIdType;
/**
...
class NodeId extends _nodeid.NodeId {
  /**
  ...
  get parent() {
    ...
    return new NodeId(NodeId.NodeIdType.STRING, this.value.substr(0, this.value.lastIndexOf(this._lastSeparator)), this.namespace);
  }
  /**
