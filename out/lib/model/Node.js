...
exports.SourceNode = exports.ServerNode = exports.ReferenceTypeNames = exports.ReferenceTypeIds = undefined;
 ...
 */
const ReferenceTypeIds = exports.ReferenceTypeIds = Object.assign({
  toParent: -1
}, _opcua_node_ids.ReferenceTypeIds);
...
class Node {
  ...
  get metadata() {
    ...
    if (this.nodeClass === _nodeclass.NodeClass.Variable) {
