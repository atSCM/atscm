...
const Decoder = {
  ...
  [_nodeOpcua.DataType.LocalizedText]: stringValue => new _nodeOpcua.LocalizedText(JSON.parse(stringValue))
};
...
const Encoder = {
  ...
  [_nodeOpcua.DataType.LocalizedText]: ({ text, locale }) => JSON.stringify({ text, locale })
};
