...
var _subscription_service = require('node-opcua/lib/services/subscription_service');

var _subscription_service2 = _interopRequireDefault(_subscription_service);
...
class SubscribeStream extends _QueueStream2.default {
  ...
  processChunk(referenceDescription, handleErrors) {
    ...
    const item = this.subscription.monitor({
      ...
      queueSize: 1,
      discardOldest: true
    }, _subscription_service2.default.TimestampsToReturn.Both);
