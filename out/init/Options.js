...
var _defaults = require('../lib/config/defaults');
...
const InitOptions = exports.InitOptions = {
  ...
  atviseHost: new _Option2.default('Atvise server host', _defaults2.default.host),
  atvisePortOpc: new _Option2.default('Atvise OPC port', _defaults2.default.port.opc),
  atvisePortHttp: new _Option2.default('Atvise HTTP port', _defaults2.default.port.http),
