...
describe.skip('Logger', function() {
  ...
  describe('.info', function() {
    it('should be printed', function() {
      ...
      // console.log('CALL COUNT', logSpy.callCount);

      expect(logSpy.calledOnce, 'to be true');
      expect(logSpy.lastCall.args[0], 'to equal', t);
    });
  });
  ...
  describe('.warn', function() {
    it('should be printed', function() {
      ...
      expect(logSpy.calledOnce, 'to be true');
      expect(warnSpy.lastCall.args[0], 'to equal', t);
    });
  });
  ...
  describe('.error', function() {
    it('should be printed using stderr', function() {
      ...
      expect(logSpy.calledOnce, 'to be true');
      expect(errorSpy.lastCall.args[0], 'to equal', t);
    });
  });
