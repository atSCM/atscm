...
class AtSCMCli extends _liftoff2.default {
  ...
  constructor(argv = []) {
     ...
     * @type {Object}
     */
    this.options = (0, _yargs2.default)(argv).option(_Options.GlobalOptions).fail((msg, e, y) => {
    ...
    }, () => this.command = command), (0, _yargs2.default)().usage('Usage: $0 [cmd=run]').options(_Options.GlobalOptions).global(globalOptionNames).strict().help('help', _Options2.default.help.desc).alias('help', 'h'));
  }
