...
function createNode(nodeId, {
  ...
  const variableOptions = nodeClass.value === _nodeclass.NodeClass.Variable.value ? {
    dataType: value.dataType.value,
    valueRank: value.arrayType ? value.arrayType.value : _variant.VariantArrayType.Scalar.value,
    value: value.arrayType && value.arrayType.value !== _variant.VariantArrayType.Scalar.value ? Array.from(value.value) : value.value
  } : {};
