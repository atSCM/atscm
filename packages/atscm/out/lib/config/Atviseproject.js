...
class Atviseproject {
  ...
  static get useTransformers() {
    return [new _AlarmConfigTransformer.default(), new _DisplayTransformer.default(this.xmlTransformerOptions), new _ScriptTransformer.ServerscriptTransformer(this.xmlTransformerOptions), new _ScriptTransformer.QuickDynamicTransformer(this.xmlTransformerOptions), new _Mapping.default()];
  }
  /**
